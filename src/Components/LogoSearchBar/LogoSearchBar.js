...
import logo1 from '../Inspector/images/logo1.jpg'; // Ensure this path is correct
        ...
        <div className='container-fluid search-container pt-2 d-flex justify-content-center align-items-center'>
            ...
            <div className="dropdown">
                ...
                <ul className="dropdown-menu">
                    <li><Link className="dropdown-item" to="/inspector">Dashboard</Link></li>
                   
                    <li><Link className="dropdown-item" to="/productforinspection">Product For Inspection</Link></li>
